...
\begin{figure}[ht]
\centering
\includegraphics[scale=.5]{or_all_complexity}
...
\begin{figure}[ht]
\centering
\includegraphics[scale=.4]{or_all_runtime}
...
\begin{figure}[ht]
\centering
\includegraphics[scale=.5]{or_worst_complexity}
\caption{The proven analytical optimal query complexity
and calculated empirical optimal query complexity by 
size of input bit string.}
...
\begin{figure}[ht]
\centering
\includegraphics[scale=.4]{or_worst_runtime}
\caption{Runtime of SDP solver by size of input strings.}
