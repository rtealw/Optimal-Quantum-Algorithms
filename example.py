...
# Example 2
#solutions = qqo.runSDPForN(getD=qqo.getDAll, getE=qqo.getEParity, n_end=2, n_start=2)
#span_vectors = solutions['span_vectors'][0]
#print(span_vectors.shape)
#print('DIMENSION:', np.linalg.matrix_rank(span_vectors))
